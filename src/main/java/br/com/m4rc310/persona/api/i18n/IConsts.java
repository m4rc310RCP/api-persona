...
// @GraphQLQuery(name=DATE$weather_minutely, description=DESC$date_weather_minutely)
	...
	public static final String DESC$field_termometry_device                = "${desc.field.termometry.device}";
	public static final String DESC$field_unity                            = "${desc.field.unity}";
	public static final String DESC$id_device                              = "${desc.id.device}";
	public static final String DESC$indicator_registry                     = "${desc.indicator.registry}";
	...
	public static final String DESC$mutation_check_number_registry         = "${desc.mutation.check.number.registry}";
	public static final String DESC$mutation_link_termometry_unity         = "${desc.mutation.link.termometry.unity}";
	public static final String DESC$mutation_termometry_device             = "${desc.mutation.termometry.device}";
	public static final String DESC$mutation_unity                         = "${desc.mutation.unity}";
	public static final String DESC$mutation_unlink_termometry_unity       = "${desc.mutation.unlink.termometry.unity}";
	...
	public static final String DESC$name_unity                             = "${desc.name.unity}";
	...
	public static final String DESC$number_unity                           = "${desc.number.unity}";
	...
	public static final String DESC$query_termometry_device                = "${desc.query.termometry.device}";
	public static final String DESC$query_test                             = "${desc.query.test}";
	public static final String DESC$query_unlinked_termometry_devices      = "${desc.query.unlinked.termometry.devices}";
	...
	public static final String DESC$type_termometry_device                 = "${desc.type.termometry.device}";
	public static final String DESC$type_unity                             = "${desc.type.unity}";
	public static final String DESC$type_weatcher_alert                    = "${desc.type.weatcher.alert}";
//--------------------------------------------------
// @GraphQLQuery(name=FIELD$termometry_device, description=DESC$field_termometry_device)
	public static final String FIELD$termometry_device                     = "${field.termometry.device}";
//--------------------------------------------------
// @GraphQLQuery(name=FIELD$unity, description=DESC$field_unity)
	public static final String FIELD$unity                                 = "${field.unity}";
//--------------------------------------------------
...
// @GraphQLQuery(name=INDICATOR$registry, description=DESC$indicator_registry)
	public static final String INDICATOR$registry                          = "${indicator.registry}";
//--------------------------------------------------
...
//--------------------------------------------------
// @GraphQLMutation(name=MUTATION$check_number_registry, description=DESC$mutation_check_number_registry)
	public static final String MUTATION$check_number_registry              = "${mutation.check.number.registry}";
//--------------------------------------------------
// @GraphQLMutation(name=MUTATION$link_termometry_unity, description=DESC$mutation_link_termometry_unity)
	public static final String MUTATION$link_termometry_unity              = "${mutation.link.termometry.unity}";
//--------------------------------------------------
// @GraphQLMutation(name=MUTATION$send_email, description=DESC$mutation_send_email)
	public static final String MUTATION$send_email                         = "${mutation.send.email}";
//--------------------------------------------------
// @GraphQLMutation(name=MUTATION$termometry_device, description=DESC$mutation_termometry_device)
	public static final String MUTATION$termometry_device                  = "${mutation.termometry.device}";
//--------------------------------------------------
// @GraphQLMutation(name=MUTATION$unity, description=DESC$mutation_unity)
	public static final String MUTATION$unity                              = "${mutation.unity}";
//--------------------------------------------------
// @GraphQLMutation(name=MUTATION$unlink_termometry_unity, description=DESC$mutation_unlink_termometry_unity)
	public static final String MUTATION$unlink_termometry_unity            = "${mutation.unlink.termometry.unity}";
//--------------------------------------------------
...
// @GraphQLQuery(name=NAME$unity, description=DESC$name_unity)
	public static final String NAME$unity                                  = "${name.unity}";
//--------------------------------------------------
...
// @GraphQLQuery(name=NUMBER$unity, description=DESC$number_unity)
	public static final String NUMBER$unity                                = "${number.unity}";
//--------------------------------------------------
...
// @GraphQLQuery(name=QUERY$termometry_device, description=DESC$query_termometry_device)
	public static final String QUERY$termometry_device                     = "${query.termometry.device}";
//--------------------------------------------------
...
// @GraphQLQuery(name=QUERY$unlinked_termometry_devices, description=DESC$query_unlinked_termometry_devices)
	public static final String QUERY$unlinked_termometry_devices           = "${query.unlinked.termometry.devices}";
//--------------------------------------------------
...
//--------------------------------------------------
// @GraphQLType(name=TYPE$termometry_device, description=DESC$type_termometry_device)
	public static final String TYPE$termometry_device                      = "${type.termometry.device}";
//--------------------------------------------------
// @GraphQLType(name=TYPE$unity, description=DESC$type_unity)
	public static final String TYPE$unity                                  = "${type.unity}";
//--------------------------------------------------
